  ...
  private loadTranslations() {
    this.translations = {
      ...
      hi: {
        ...
        streaks: {
          title: 'स्ट्रीक्स',
          subtitle: 'अपनी निरंतरता को ट्रैक करें और बैज अर्जित करें!',
          current: 'वर्तमान स्ट्रीक',
          longest: 'सबसे लंबी स्ट्रीक',
          total: 'कुल दिन लॉग किए गए',
          last: 'अंतिम:',
          noEntries: 'अभी तक कोई एंट्री नहीं',
          personalBest: 'आपका व्यक्तिगत सर्वश्रेष्ठ!',
          keepUp: 'जारी रखें!',
          ...
          info: {
             daily: 'दैनिक लॉगिंग',
             dailyDesc: 'अपनी स्ट्रीक बनाए रखने के लिए रोजाना अपना वजन ट्रैक करें',
             badges: 'बैज अर्जित करें',
             badgesDesc: 'निरंतरता के लिए उपलब्धियां अनलॉक करें',
             progress: 'प्रगति देखें',
             progressDesc: 'हीटमैप में अपनी स्ट्रीक का इतिहास देखें'
          },
          badges: {
             trailblazer: 'ट्रेलब्लेज़र',
             trailblazerDesc: 'अपनी प्रोफ़ाइल पूर्ण करें',
             trailblazerLock: 'नाम और उम्र जोड़ें',
             firstStep: 'पहला कदम',
             firstStepDesc: 'अपना पहला वजन लॉग करें',
             firstStepLock: 'ट्रैकिंग शुरू करें',
             legend: 'लीजेंड',
             legendDesc: '365-दिन की स्ट्रीक',
             weekender: 'वीकेंडर',
             weekenderDesc: '7-दिन की स्ट्रीक',
             fortnight: 'फोर्टनाइट फाइटर',
             fortnightDesc: '14-दिन की स्ट्रीक',
             centurion: 'सेंचुरियन',
             centurionDesc: '100-दिन की स्ट्रीक',
             dataCollector: 'डेटा कलेक्टर',
             dataCollectorDesc: '50 कुल एंट्रीज',
             dedicated: 'समर्पित',
             dedicatedDesc: '100 कुल एंट्रीज',
             earned: 'अर्जित!'
          }
        },
      ...
      ta: {
        ...
        streaks: {
          title: 'ஸ்ட்ரீக்ஸ்',
          subtitle: 'உங்கள் நிலைத்தன்மையைக் கண்காணித்து பேட்ஜ்களைப் பெறுங்கள்!',
          current: 'தற்போதைய ஸ்ட்ரீக்',
          longest: 'நீண்ட ஸ்ட்ரீக்',
          total: 'மொத்த நாட்கள் பதிவு செய்யப்பட்டது',
          last: 'கடைசி:',
          noEntries: 'இன்னும் பதிவுகள் இல்லை',
          personalBest: 'உங்கள் சிறந்த சாதனை!',
          keepUp: 'தொடருங்கள்!',
          achievements: 'உங்கள் சாதனைகள்',
          days: 'நாட்கள்',
          entries: 'பதிவுகள்',
          info: {
             daily: 'தினசரி பதிவு',
             dailyDesc: 'உங்கள் ஸ்ட்ரீக்கைப் பராமரிக்க தினமும் உங்கள் எடையைக் கண்காணிக்கவும்',
             badges: 'பேட்ஜ்களைப் பெறுங்கள்',
             badgesDesc: 'நிலைத்தன்மைக்கான சாதனைகளைத் திறக்கவும்',
             progress: 'முன்னேற்றத்தைக் காண்க',
             progressDesc: 'ஹீட்மேப்பில் உங்கள் ஸ்ட்ரீக் வரலாற்றைக் காண்க'
          },
          badges: {
             trailblazer: 'டிரெயில்பிளேசர்',
             trailblazerDesc: 'உங்கள் சுயவிவரத்தை நிரப்பவும்',
             trailblazerLock: 'பெயர் & வயதைச் சேர்க்கவும்',
             firstStep: 'முதல் படி',
             firstStepDesc: 'உங்கள் முதல் எடையைப் பதிவு செய்யவும்',
             firstStepLock: 'கண்காணிப்பைத் தொடங்கவும்',
             legend: 'லெஜெண்ட்',
             legendDesc: '365-நாள் ஸ்ட்ரீக்',
             weekender: 'வீகெண்டர்',
             weekenderDesc: '7-நாள் ஸ்ட்ரீக்',
             fortnight: 'ஃபோர்ட்நைட் ஃபைட்டர்',
             fortnightDesc: '14-நாள் ஸ்ட்ரீக்',
             centurion: 'சென்ச்சூரியன்',
             centurionDesc: '100-நாள் ஸ்ட்ரீக்',
             dataCollector: 'டேட்டா கலெக்டர்',
             dataCollectorDesc: '50 மொத்த பதிவுகள்',
             dedicated: 'அர்ப்பணிப்பு',
             dedicatedDesc: '100 மொத்த பதிவுகள்',
             earned: 'பெற்றது!'
          }
        },
      ...
      fr: {
        ...
        streaks: {
          title: 'Séries',
          subtitle: 'Suivez votre régularité et gagnez des badges!',
          current: 'Série Actuelle',
          longest: 'Série la Plus Longue',
          total: 'Total de Jours Enregistrés',
          last: 'Dernier:',
          noEntries: 'Pas encore d\'entrées',
          personalBest: 'Votre meilleur personnel!',
          keepUp: 'Continuez!',
          ...
          info: {
             ...
             dailyDesc: 'Suivez votre poids quotidiennement pour maintenir votre série',
             badges: 'Gagnez des Badges',
             badgesDesc: 'Débloquez des réalisations pour la régularité',
             progress: 'Voir les Progrès',
             progressDesc: 'Voir l\'historique de votre série dans une carte thermique'
          },
          badges: {
             trailblazer: 'Pionnier',
             trailblazerDesc: 'Complétez votre profil',
             trailblazerLock: 'Ajoutez nom & âge',
             firstStep: 'Premier Pas',
             firstStepDesc: 'Enregistrez votre premier poids',
             firstStepLock: 'Commencez le suivi',
             legend: 'Légende',
             legendDesc: 'Série de 365 jours',
             weekender: 'Week-endeur',
             weekenderDesc: 'Série de 7 jours',
             fortnight: 'Combattant Quinzaine',
             fortnightDesc: 'Série de 14 jours',
             centurion: 'Centurion',
             centurionDesc: 'Série de 100 jours',
             dataCollector: 'Collecteur de Données',
             dataCollectorDesc: '50 entrées au total',
             dedicated: 'Dévoué',
             dedicatedDesc: '100 entrées au total',
             earned: 'Gagné!'
          }
        },
      ...
      de: {
        ...
        streaks: {
          title: 'Serien',
          subtitle: 'Verfolgen Sie Ihre Beständigkeit und verdienen Sie Abzeichen!',
          current: 'Aktuelle Serie',
          longest: 'Längste Serie',
          total: 'Gesamt Protokollierte Tage',
          last: 'Zuletzt:',
          noEntries: 'Noch keine Einträge',
          personalBest: 'Ihre persönliche Bestleistung!',
          keepUp: 'Weiter so!',
          achievements: 'Ihre Erfolge',
          days: 'Tage',
          entries: 'Einträge',
          info: {
             daily: 'Tägliches Protokollieren',
             dailyDesc: 'Verfolgen Sie Ihr Gewicht täglich, um Ihre Serie aufrechtzuerhalten',
             badges: 'Abzeichen Verdienen',
             badgesDesc: 'Erfolge für Beständigkeit freischalten',
             progress: 'Fortschritt Anzeigen',
             progressDesc: 'Sehen Sie Ihre Serienhistorie in einer Heatmap'
          },
          badges: {
             trailblazer: 'Wegbereiter',
             trailblazerDesc: 'Vervollständigen Sie Ihr Profil',
             trailblazerLock: 'Name & Alter hinzufügen',
             firstStep: 'Erster Schritt',
             firstStepDesc: 'Protokollieren Sie Ihr erstes Gewicht',
             firstStepLock: 'Tracking starten',
             legend: 'Legende',
             legendDesc: '365-Tage-Serie',
             weekender: 'Wochenender',
             weekenderDesc: '7-Tage-Serie',
             fortnight: 'Vierzehn-Tage-Kämpfer',
             fortnightDesc: '14-Tage-Serie',
             centurion: 'Zenturio',
             centurionDesc: '100-Tage-Serie',
             dataCollector: 'Datensammler',
             dataCollectorDesc: '50 Einträge insgesamt',
             dedicated: 'Engagiert',
             dedicatedDesc: '100 Einträge insgesamt',
             earned: 'Verdient!'
          }
        },
        home: { title: 'Gewichtstracker', addEntry: 'Eintrag Hinzufügen', noEntries: 'Noch keine Gewichtseinträge', getStarted: 'Fügen Sie Ihren ersten Gewichtseintrag hinzu, um zu beginnen!' },
